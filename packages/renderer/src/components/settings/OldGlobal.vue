    ...
    <div>
        <b-tabs v-model="tabIndex">
                    ...
                    >
                        ...
                        >
                            <template #cell(abb)="row">
                                <b-form-input v-model="row.item.abb" disabled />
                            </template>
            ...
            <b-tab>
                ...
                <b-row>
                    <b-col>
                        <b-list-group v-for="c in commendRequests" :key="c.id">
                            <b-list-group-item>
                                <b-card
        ...
        >
            <p>
                ...
                <span v-show="selectedNomination.list.name == 'dave'">
                    Svensk standardlista
                </span>
            </p>
            <hr />
            <p>
            ...
            <p>
                <b-list-group>
                    ...
                    >
                        {{ comment.message }}
                        <b-badge variant="info"> Botvid </b-badge>
                    </b-list-group-item>
                </b-list-group>
                <b-form @submit="onSubmitCommend" @reset="onResetCommend">
                    <b-form-group label="Lägg till kommentar">
                        <b-form-input />
                    </b-form-group>
                </b-form>
            </p>
            <b-button variant="success" @click="confirmCommend()">
                Slutför
            </b-button>
            <b-button variant="primary"> Skicka </b-button>
            <b-button variant="danger" @click="confirmDeny()"> Neka </b-button>
        </b-modal>
    </div>
</template>
