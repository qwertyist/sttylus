            ...
            changelog: [
                {
                    ...
                    changes: [
                        ...
                        },
                        {
                            ...
                            type: 'fix',
                            description:
                                'Delade förkortningslistor kan sparas/importeras.',
                        },
                    ],
                },
                {
                ...
                },
                {
                    ...
                    changes: [
                        ...
                        },
                        {
                            ...
                            type: 'update',
                            description:
                                'Förkortningslistor kan exporteras som textfil',
                        },
                        {
                            id: 3,
                            type: 'minor',
                        ...
                        },
                        {
                            ...
                            type: 'minor',
                            description:
                                'Fler och tydligare felmeddelanden och popups',
                        },
                        {
                            id: 5,
                            type: 'fix',
                            description:
                                "Åtgärdat en bugg där funktionen 'Tolkning på projektorduk eller extern skärm' inte ville hoppa igång om man klickat runt för mycket i menyer innan.",
                        },
                        {
                            id: 6,
                            type: 'fix',
                ...
                },
                {
                    ...
                    changes: [
                        ...
                        },
                        {
                            ...
                            type: 'update',
                            description:
                                'Lös ut förkortningar med bortvänd parentes )',
                        },
                        {
                            id: 2,
                            type: 'update',
                        ...
                        },
                        {
                            ...
                            type: 'update',
                            description:
                                'Ta bort föregående ord i manuskript med pil vänster',
                        },
                        {
                            id: 4,
                            type: 'minor',
                            description:
                                '<i>Påminn inte</i> i stödtolkningsrutan döljer förkortningen direkt.',
                        },
                        {
                            id: 5,
                            type: 'update',
                            description:
                                'Knapp för att nollställa missade förkortningar.',
                        },
                        {
                            id: 6,
                            type: 'update',
                            description:
                                'Export av ämneslistor i STTylus fungerar',
                        },
                    ],
                },
                {
                    ...
                    changes: [
                        ...
                        },
                        {
                            ...
                            type: 'minor',
                            description:
                                'Tillåt ej att scrolla horisontellt i skrivläget',
                        },
                        {
                            id: 3,
                            type: 'minor',
                            description:
                                'Rensa/nollställ stödtolkningsrutan när den stängs',
                        },
                        {
                            id: 4,
                            type: 'update',
                    ...
                    changes: [
                        {
                            ...
                            type: 'update',
                            description:
                                '<h2>Zoom-funktionaliteten är släckt tills vidare</h2>',
                        },
                        {
                            id: 1,
                            type: 'update',
                        ...
                        },
                        {
                            ...
                            type: 'minor',
                            description:
                                'Flyttat infomeddelanden till övre högra hörnet',
                        },
                        {
                            id: 4,
                            type: 'minor',
                        ...
                        },
                        {
                            ...
                            type: 'update',
                            description:
                                'Byt standardlista med <kbd>CTRL+1...5</kbd>',
                        },
                    ],
                },
                {
                    ...
                    changes: [
                        {
                            ...
                            type: 'update',
                            description:
                                'Exportera/importera mellan STTylus-konton och mellan online/offline-versionerna.',
                        },
                        {
                            id: 1,
                            type: 'update',
                            description:
                                "Optimerat förkortningsvyn kraftigt. 'Fuzzy search' i förkortningar, man behöver alltså inte söka på hela frasen eller stava rätt för att hitta matchande förkortningar.",
                        },
                        {
                            id: 2,
                            type: 'fix',
                            description:
                                'Alla dialogrutor stänger om man trycker på escape',
                        },
                        {
                            id: 3,
                            type: 'fix',
                            description:
                                '<kbd>CTRL+HÖGERPIL</kbd> stannar vid sista positionen i texten.',
                        },
                    ],
                },
                {
                    ...
                    changes: [
                        ...
                        },
                        {
                            ...
                            type: 'update',
                            description:
                                '<kbd>F11</kbd> växlar till och från fullskärm i offline-versionen.',
                        },
                    ],
                },
                {
                    ...
                    changes: [
                        {
                            ...
                            type: 'update',
                            description:
                                '<h2>STTylus finns nu som desktop- och offlineversion.</h2>',
                        },
                    ],
                },
                {
                    ...
                    changes: [
                        ...
                        },
                        {
                            ...
                            type: 'fix',
                            description:
                                'Delad lista funktionen har bättre och säkrare felhantering.',
                        },
                    ],
                },
                {
                ...
                },
                {
                    ...
                    changes: [
                        ...
                        },
                        {
                            ...
                            type: 'minor',
                            description:
                                'Tolkanvändare kan byta radavstånd och typsnitt.',
                        },
                        {
                            id: 3,
                            type: 'update',
                ...
                },
                {
                    ...
                    changes: [
                        ...
                        },
                        {
                            ...
                            type: 'minor',
                            description:
                                "Större text i 'Lägg till förkortning'.",
                        },
                        {
                            id: 2,
                            type: 'minor',
