                        ...
                        >
                            ...
                            <template #cell(word)="row">
                                ...
                                <b-form-input
                                    ...
                                    @change="
                                        onUpdateAbb(row.item, viewedList.id)
                                    "
                                />
    ...
    methods: {
        ...
        onSubmitRemove(evt) {
            ...
            if (this.removelist.type < 3) {
                api.deleteList(this.removeList.id)
                    .then(() => {
                        this.$refs['remove-list-modal'].hide()
                        this.getLists(true)
                        this.removelist = {
                    ...
                    .catch((err) => {
                        console.log(
                            'something went wrong when removing list:',
                            err
                        )
                        alert(err)
                    })
