        ...
        <b-form-select name="fontFamily" id="fontFamily" v-model="form.family.selected">
          ...
          >{{fontFamily}}</option>
            ...
            <b-row>
              ...
              <b-col>
                <b-form-select v-model="form.family.selected" :options="form.family.options" />
              </b-col>
            </b-row>
            <b-row>
              <b-col cols="3">
            ...
            <b-form-group label="Radavstånd">
              <b-form-radio-group v-model="form.lineHeight">
                <b-form-radio
                  v-for="(lineHeight, indexOpt) in form.lineHeights"
                  :value="lineHeight"
                  :key="indexOpt"
                ...
                >
                  ...
                  >
                    <span style="width: 100%">
                      <strike v-if="indexOpt == 6 && !form.customColors.valid">{{ colors.text }}</strike>
                      <span v-else>{{ colors.text }}</span>
                      <b-icon-brush
  ...
  methods: {
    ...
    onMarginChange(val) {
      if (this.form.margins.linked) {
        ...
        if (!val) {
          ...
          val = Math.max(this.form.margins.bottom, this.form.margins.top, this.form.margins.left, this.form.margins.right)
        }
      ...
      this.$nextTick(() => {
        ...
        const fontSettings = {
          font: {
            ...
            foreground: this.colorOptions[selectedColor].colors.foreground,
            background: this.colorOptions[selectedColor].colors.background,
            lineHeight: this.form.lineHeight,
          },
          behaviour: {
    ...
    getSettings() {
      ...
      if (fontSettings.customColors.valid) {
        this.colorOptions[6].colors.foreground = fontSettings.customColors.foreground
        this.colorOptions[6].colors.background = fontSettings.customColors.background
