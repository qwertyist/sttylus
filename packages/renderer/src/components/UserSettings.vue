<template>
    <b-container fluid class="no-gutters navMargin">
        <b-row class="d-block">
            <b-tabs v-model="tabIndex" class="navbar-dark" content-class="">
                <b-tab
                    title="Förkortningar"
...
export default {
    ...
    methods: {
        addEventListeners() {
            ...
            EventBus.$on(
                'unsavedManuscriptChanges',
                this.unsavedManuscriptChanges
            )
        ...
        unsavedManuscriptChanges(changes) {
            if (changes) {
                this.$toast.warning(
                    'Manuskriptet du redigerar har osparade ändringar'
                )
            }
        },
      ...
      */
        ...
        close(e) {
            ...
            this.$bvModal
                .msgBoxConfirm(
                    'Är du säker på att du vill avsluta programmet?',
                    {
